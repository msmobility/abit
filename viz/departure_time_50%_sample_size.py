...
BASE_TOURS_CSV = r"C:\Users\Nawidullah\IdeaProjects\abit_standalone\output\50pct-sample-size\base-scenario-0-00pct-telework-50pct-sample-size\tours.csv"
TELE20_TOURS_CSV = r"C:\Users\Nawidullah\IdeaProjects\abit_standalone\output\50pct-sample-size\scenario-1-20pct-telework-50pct-sample-size\tours.csv"
TELE40_TOURS_CSV = r"C:\Users\Nawidullah\IdeaProjects\abit_standalone\output\50pct-sample-size\scenario-2-40pct-telework-50pct-sample-size\tours.csv"
TELE80_TOURS_CSV = r"C:\Users\Nawidullah\IdeaProjects\abit_standalone\output\50pct-sample-size\scenario-3-80pct-telework-50pct-sample-size\tours.csv"

OUTPUT_DIR = r"C:\Users\Nawidullah\IdeaProjects\abit\viz\departure_time_50pct_sample"
...
for d in range(1, 8):
    ...
    ax.set_title(
        f"Daily work departure times relative to baseline ({BIN_MINUTES}-min bins) {SAMPLE_SUFFIX} - {day_labels[d]}"
    )
    ...
    output_file = os.path.join(
        OUTPUT_DIR,
        f"work_departure_share_vs_base_50pct_sample_{BIN_MINUTES}min_{day_labels[d]}.png"
    )
