...
import abm.calibration.HabitualModeChoiceCalibration;
...
public class RemoteWorkFrequencyGeneratorCalibration implements ModelComponent {

    //Todo define a few calibration parameters
    static Logger logger = Logger.getLogger(RemoteWorkFrequencyGeneratorCalibration.class);
    DataSet dataSet;
    ...
    public RemoteWorkFrequencyGeneratorCalibration(DataSet dataSet) {
