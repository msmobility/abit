                ...
                if (person.getPlan()!=null){
                    ...
                    for (Tour tour : person.getPlan().getTours().values()){
                        ...
                        for (Leg leg : tour.getLegs().values()){
                            ...
                            double speed = leg.getDistance() / ((double) leg.getTravelTime_min() + 1);
                    ...
                    if (person.getPlan()!=null && person.getAge()>5) {
                        for (Tour tour : person.getPlan().getTours().values()){
                            for (Leg leg : tour.getLegs().values()){
                                ...
                                double currStartTime = (double) leg.getPreviousActivity().getEndTime_min();
                                double currEndTime = (double) leg.getNextActivity().getStartTime_min();
                                ...
                                if (!childTrip.keySet().contains(currDestinationAndSchedule)){
                                    childTrip.put(currDestinationAndSchedule,1);
                                }else {
