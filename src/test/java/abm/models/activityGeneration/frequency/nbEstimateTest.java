...
public class nbEstimateTest {
    private Logger logger = Logger.getLogger(nbEstimateTest.class);
    ...
    public void test() {
        ...
        double[] param = frequencyGeneratorModel.nbEstimateParam(person_test_2);
