...
public class PolrEstimateTest {

    private Logger logger = Logger.getLogger(PolrEstimateTest.class);
    ...
    public void setup(){
        ...
        frequencyGeneratorModel = new FrequencyGeneratorModel(dataset, Purpose.WORK);
    }
    ...
    public void test() {
        ...
        assertArrayEquals(expectProbability, probability,0.001);
}
